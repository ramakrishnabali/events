...
class Events extends Component {
  ...
  getStatus = id => {
    const eventDetails = eventsList.find(each => each.id === id)
    const eventStatus = eventDetails.registrationStatus

    this.setState({registrationStatus: eventStatus})
  }
    ...
    return (
      <div className="appContainer">
        <div className="eventsContainer">
          ...
          <ul className="eventsListContainer">
